   ...
   return (
    <>
      ...
      <style>{`
        ...
        .form-animate {
          animation: fadeSlideUp 0.7s cubic-bezier(.22,1,.36,1) both;
        }
        .btn-fire {
        ...
        .btn-fire:hover {
          ...
          box-shadow: 0 10px 36px rgba(253,71,63,0.6);
        }
        .btn-fire:active {
        ...
        .input-field:focus {
          outline: none;
          border-color: #fd473f !important;
          box-shadow: 0 0 0 3px rgba(253,71,63,0.18);
      ...
      >
        ...
        >
          ...
          <div style={{ display:"flex", gap:"12px", marginBottom:"24px" }}>
            {[
              { label:"Google", color:"#fff", bg:"rgba(255,255,255,0.06)", border:"rgba(255,255,255,0.1)", icon:(
              ...
              { label:"Apple",  color:"#fff", bg:"rgba(255,255,255,0.06)", border:"rgba(255,255,255,0.1)", icon:(
              ...
              <button
                ...
                style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", gap:"8px", padding:"11px", borderRadius:"14px", background:btn.bg, border:`1px solid ${btn.border}`, color:btn.color, fontWeight:700, fontSize:"14px", cursor:"pointer" }}
              >
                {btn.icon}
                {btn.label}
              </button>
          ...
          {/* Divider */}
          <div className="divider-line" style={{ display:"flex", alignItems:"center", gap:"12px", marginBottom:"24px" }}>
            <span style={{ fontSize:"12px", color:"rgba(255,255,255,0.3)", fontWeight:700, letterSpacing:"1px", whiteSpace:"nowrap" }}>or sign in with email</span>
          </div>

          {/* Email field */}
          <div style={{ marginBottom:"16px" }}>
            <label style={{ display:"block", fontSize:"12px", fontWeight:700, color:"rgba(255,255,255,0.45)", letterSpacing:"1.5px", textTransform:"uppercase", marginBottom:"8px" }}>
              Email
            </label>
            <div style={{ position:"relative" }}>
              <span style={{ position:"absolute", left:"14px", top:"50%", transform:"translateY(-50%)", color: focused==="email" ? "#fd473f" : "rgba(255,255,255,0.25)", transition:"color 0.2s", pointerEvents:"none" }}>
              ...
              <input
                ...
                style={{ width:"100%", paddingLeft:"42px", paddingRight:"16px", paddingTop:"13px", paddingBottom:"13px", borderRadius:"14px", background:"rgba(255,255,255,0.05)", border:"1.5px solid rgba(255,255,255,0.1)", color:"#fff", fontSize:"15px", fontFamily:"'Nunito', sans-serif", boxSizing:"border-box" }}
              />
            </div>
          </div>
          ...
          <div style={{ marginBottom:"10px" }}>
            ...
            <div style={{ position:"relative" }}>
              <span style={{ position:"absolute", left:"14px", top:"50%", transform:"translateY(-50%)", color: focused==="pass" ? "#fd473f" : "rgba(255,255,255,0.25)", transition:"color 0.2s", pointerEvents:"none" }}>
                <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <input
                ...
                style={{ width:"100%", paddingLeft:"42px", paddingRight:"46px", paddingTop:"13px", paddingBottom:"13px", borderRadius:"14px", background:"rgba(255,255,255,0.05)", border:"1.5px solid rgba(255,255,255,0.1)", color:"#fff", fontSize:"15px", fontFamily:"'Nunito', sans-serif", boxSizing:"border-box" }}
              />
              <button
          ...
          <div style={{ textAlign:"right", marginBottom:"24px" }}>
            <a href="#" style={{ fontSize:"13px", color:"#fd473f", fontWeight:700, textDecoration:"none" }}>
              Forgot password?
            </a>
          </div>
          ...
          {/* Error */}
          {error && (
            <div style={{ background:"rgba(253,71,63,0.12)", border:"1px solid rgba(253,71,63,0.3)", borderRadius:"12px", padding:"10px 14px", marginBottom:"16px", color:"#ff8a80", fontSize:"13px", fontWeight:600 }}>
              ⚠️ {error}
            </div>
          )}
          ...
          <button
            className="btn-fire"
            onClick={handlelogin}
            style={{ width:"100%", padding:"15px", borderRadius:"16px", color:"#fff", fontSize:"16px", fontWeight:800, cursor:"pointer", letterSpacing:"0.5px", marginBottom:"14px", display:"flex", alignItems:"center", justifyContent:"center", gap:"8px" }}
          >
            🔥 Sign In
          </button>
          ...
          >
            New here? <span style={{ color:"#fd473f" }}>Create account ✨</span>
          </button>
